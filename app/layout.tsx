      ...
      <head>
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          body { font-family: 'Apple SD Gothic Neo', 'Pretendard', 'Noto Sans KR', sans-serif; background: #f4f5f7; color: #1a1a1a; font-size: 14px; line-height: 1.6; min-height: 100vh; display: flex; flex-direction: column; }
      ...
      <body>
        ...
        <footer style={{ borderTop: '1px solid #e5e7eb', background: '#f4f5f7', padding: '16px 20px', textAlign: 'center' }}>
          <div style={{ fontSize: 12, color: '#9ca3af' }}>
            © 2026 ATELIER_HOUSE · Developed by ATELIER_HOUSE · v1.2.2. All rights reserved.
          </div>
        </footer>
      </body>
    </html>
